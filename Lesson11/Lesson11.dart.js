...
Isolate.$defineClass("Example", "Object", ["moonRotationMatrix", "mvMatrixStack", "mvMatrix", "pMatrix", "moonVertexIndexBuffernumItems", "moonVertexIndexBufferitemSize", "moonVertexIndexBuffer", "moonVertexTextureCoordBuffernumItems", "moonVertexTextureCoordBufferitemSize", "moonVertexTextureCoordBuffer", "moonVertexNormalBuffernumItems", "moonVertexNormalBufferitemSize", "moonVertexNormalBuffer", "moonVertexPositionBuffernumItems", "moonVertexPositionBufferitemSize", "moonVertexPositionBuffer", "moonTexture?", "directionalColorUniform", "lightingDirectionUniform", "ambientColorUniform", "useLightingUniform", "samplerUniform", "nMatrixUniform", "mvMatrixUniform", "pMatrixUniform", "vertexNormalAttribute", "textureCoordAttribute", "vertexPositionAttribute", "shaderProgram", "viewportHeight", "viewportWidth", "gl?", "canvas"], {
 init$0: function() {
  this.canvas = $.document().query$1('#lesson11-canvas');
  ...
  this.moonRotationMatrix = $.Matrix4$0();
  this.moonRotationMatrix.identity$0();
  this._initShaders$0();
  this._initBuffers$0();
  this._initTexture$0();
  this._initMouse$0();
 ...
 _drawScene$0: function() {
  ...
  this.mvMatrix.translate$1($.Vector3$fromList$1([0.0, 0.0, -6.0]));
  this.mvMatrix.multiply$2(this.mvMatrix, this.moonRotationMatrix);
 ...
 _initBuffers$0: function() {
  ...
  for (var latNumber = 0; latNumber <= 30; latNumber = latNumber + 1) {
    ...
    if (typeof sinTheta !== 'number') return this._initBuffers$0$bailout(1, vertexPositionData, normalData, textureCoordData, latNumber, theta, sinTheta);
    var cosTheta = $.cos(theta);
    if (typeof cosTheta !== 'number') return this._initBuffers$0$bailout(2, vertexPositionData, normalData, textureCoordData, sinTheta, latNumber, cosTheta);
    var t0 = latNumber / 30;
    var t1 = 2 * cosTheta;
    var v = 1 - t0;
  ...
  this.gl.bindBuffer$2(34963, this.moonVertexIndexBuffer);
  this.gl.bufferData$3(34963, $.Uint16Array$fromList(indexData), 35044);
 ...
 _initBuffers$0$bailout: function(state, env0, env1, env2, env3, env4, env5) {
  switch (state) {
    case 1:
      vertexPositionData = env0;
      normalData = env1;
      textureCoordData = env2;
      latNumber = env3;
      theta = env4;
      sinTheta = env5;
      break;
...
Isolate.$defineClass("Vector3", "Object", ["_unprojectVec", "_unprojectMat", "_items"], {
 ...
 get$length: function() { return new $.Closure10(this); },
 ...
 multiply$2: function(vec2, dest) {
  if ($.eqNullB(dest)) {
    var t0 = this._items;
    var t1 = $.index(vec2, 0);
    $.indexSet(t0, 0, $.mul($.index(t0, 0), t1));
    var t2 = this._items;
    var t3 = $.index(vec2, 1);
    $.indexSet(t2, 1, $.mul($.index(t2, 1), t3));
    var t4 = this._items;
    var t5 = $.index(vec2, 2);
    $.indexSet(t4, 2, $.mul($.index(t4, 2), t5));
  } else {
...
Isolate.$defineClass("Closure5", "Closure7", ["this_2", "box_0"], {
 $call$1: function(e) {
  this.this_2.get$gl().pixelStorei$2(37440, 1);
  this.this_2.get$gl().bindTexture$2(3553, this.this_2.get$moonTexture());
  this.this_2.get$gl().texImage2D$6(3553, 0, 6408, 6408, 5121, this.box_0.moonTextureImage_1);
...
Isolate.$defineClass('Closure9', 'Closure7', function BoundClosure(self) { this.self = self; }, {
 $call$0: function() { return this.self.load$0(); }
});
Isolate.$defineClass('Closure10', 'Closure7', function BoundClosure(self) { this.self = self; }, {
...
$.Example$0 = function() {
  return new $.Example((void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0));
};
...
$.$defineNativeClass('HTMLMediaElement', ["src!"], {
 ...
 get$load: function() { return new $.Closure9(this); },
 get$on: function() {
